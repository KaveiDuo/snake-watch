...
final placeGroups = <PlaceGroup>[
  ...
  PlaceGroup('CAMPUS BUILDINGS', [
    ...
    _b('Swimming Pool'),
    _b('IITG Temple'),
    _b('IIT Guwahati Viewpoint'),
  ]),
  PlaceGroup('FACULTY & STAFF HOUSING', [
    _b('A-type Quarters'),
    _b('B-type Quarters'),
    _b('C-type Quarters'),
    _b('D-type Quarters'),
    _b('E-type Quarters'),
    _b('F-type Quarters'),
    _b('Professors Quarters'),
    _b('Tower Block'),
    _b('B-type Community Hall'),
    _b('D-type Community Hall'),
    _b('KV Staff Quarters'),
  ]),
  PlaceGroup('SCHOOLS', [_b('Kendriya Vidyalaya (KV)'), _b('Faculty Higher Secondary School')]),
  PlaceGroup('FIELDS & PLAYGROUNDS', covered: false, [
    _open('Football Ground'),
    _open('Cricket Ground'),
    _open('Cricket Pitch'),
    _open('Athletics Ground'),
    _open('Hockey Ground'),
    _open('Tennis Courts'),
    _open('Basketball Court'),
    _open('Volleyball Court'),
    _open("Children's Park"),
    _open('Food Stalls Area'),
    _open('Botanical Garden / Green Belt'),
  ]),
  PlaceGroup('ROADS & PATHS', covered: false, [
    _open('Radhasura Road'),
    _open('Suryamukhi Road'),
    _open('IITG Border Road'),
    _open('Godhuli Gopal Path'),
    _open('Road across View Point'),
    _open('Hare Krishna Mandir Marg'),
    _open('IIT Road'),
    _open('KV Road'),
    _open('North Guwahati Road'),
    _open('Footpath surrounding sports area'),
    _open('Cycle Track behind Core'),
  ]),
  PlaceGroup('LAKES & FOREST', covered: false, [
    _open('Serpentine Lake'),
    _open('IITG Lake'),
    _open('Lake opposite Guest House'),
    _open('Forest / hill area'),
  ]),
