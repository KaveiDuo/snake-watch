      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Reference photos only — never handle a snake to identify it. Treat every unidentified snake as venomous.',
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Tag(
                      s.venomous ? 'VENOMOUS' : 'HARMLESS',
                      fg: s.venomous ? C.redText : C.greenText,
                      bg: s.venomous ? C.redSoft : C.greenSoft,
                    ),
                    const SizedBox(height: 8),
                    Text(s.name, style: ft(22, w: 700)),
                    Text(
                      s.latin,
                      style: ft(13, color: C.muted).copyWith(fontStyle: FontStyle.italic),
                    ),
      ...
      child: Row(
        ...
        children: [
          ClipRRect(
            ...
            child: SizedBox(width: 72, height: 72, child: Image.asset(s.photo, fit: BoxFit.cover)),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  s.latin,
                  style: ft(11.5, color: C.muted).copyWith(fontStyle: FontStyle.italic),
                ),
                const SizedBox(height: 5),
                Text(
                  s.about,
                  style: ft(12.5, color: C.sub, height: 1.4),
                  maxLines: 3,
