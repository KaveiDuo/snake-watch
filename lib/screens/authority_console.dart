      ...
      body: Column(children: [
        Padding(
          ...
          child: Row(children: [
            GestureDetector(
              ...
              child: Row(children: [
                ClipRRect(borderRadius: BorderRadius.circular(13), child: Image.asset('assets/images/avatar_authority.jpg', width: 44, height: 44, fit: BoxFit.cover)),
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  if (s.filterOpenOnly) ...[const SizedBox(width: 5), const Icon(Icons.close_rounded, size: 13, color: Colors.white)],
                ]),
                ),
              ),
            ),
        ...
        Expanded(
          child: ListView(padding: const EdgeInsets.fromLTRB(16, 0, 16, 24), children: [
            ...
            Text(
              'You only see reports for ${s.authorityHostel}. Other hostels go to their own hostel authority. '
        ...
        Row(children: [
          Expanded(
            child: r.safe
                ...
                : Btn('Mark area safe', height: 50, onTap: () {
                    s.markSafe(r, true);
  ...
  Widget build(BuildContext context) {
    ...
    Widget stat(String v, String l, Color c) => Expanded(
          child: Column(children: [
            ...
            const SizedBox(height: 4),
            Text(l, style: ft(12, color: C.muted), textAlign: TextAlign.center),
          ]),
        );
    return DarkPage(
      ...
      body: ListView(padding: const EdgeInsets.fromLTRB(16, 0, 16, 30), children: [
        ...
        const SizedBox(height: 12),
        InfoCard([
          InfoRow(Icons.call_outlined, 'Registered phone', '+91 98765 43210',
              editable: false, trailing: const Tag('VERIFIED', fg: C.green, bg: C.greenSoft)),
