...
class _SosScreenState extends State<SosScreen> with SingleTickerProviderStateMixin {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: AnimatedSwitcher(duration: const Duration(milliseconds: 350), child: _calling ? _callingView(last) : _holdView(last)),
            ),
          ],
        ),
      ),
  ...
  Widget _holdView(Report? last) => ListView(
    key: const ValueKey('hold'),
    padding: const EdgeInsets.fromLTRB(20, 10, 20, 24),
    children: [
      Text(
        'Hold the button to call IITG Hospital. Your location and the latest snake report go to the hospital and campus security at the same time.',
        textAlign: TextAlign.center,
        style: ft(13.5, color: C.muted, height: 1.5),
      ),
                ...
                children: [
                  SizedBox(
                    ...
                    child: CircularProgressIndicator(
                      ...
                      strokeWidth: 5,
                      color: Colors.white,
                      backgroundColor: const Color(0x33FF453A),
                    ),
                  ),
                  Container(
  ...
  Widget _callingView(Report? last) => ListView(
